...
import { decrement, fetchUserById, increment, incrementByAmount, value } from '../slices/accountSlice'
  ...
  return (
    <>
      ...
      <h2 className='main_heading justify_center'>** Account Component **</h2>
        ...
        <button className=' mx-2' onClick={()=>dispatch(fetchUserById(2))}>init user</button>
        </div>
    </>
  )
}